  ...
  function Ba(t, e) {
    ...
    return (
      r &&
        ...
        ((t._start = da(
          r._time -
            (0 < t._ts ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts),
        )),
        Aa(t),
        r._dirty || ua(r, t)),
      t
        ...
        if (!_) {
          ...
          'random' === g && Ya(_),
            ...
            (_.v = d =
              (parseFloat(c.amount) ||
                parseFloat(c.each) *
                  (d < f ? d - 1 : b ? ('y' === b ? d / f : f) : Math.max(f, d / f)) ||
                0) * ('edges' === g ? -1 : 1)),
            (_.b = d < 0 ? v - d : v),
  ...
  function _a(u, t) {
    ...
    return (
      !e &&
        s(u) &&
        ((h = e = u.radius || Y),
        u.values ? ((u = xt(u.values)), (l = !q(u[0])) && (h *= h)) : (u = $a(u.increment))),
      Pa(
        t,
        e
          ? p(u)
            ...
            : function (t) {
                for (
                  ...
                  (e = l ? (e = u[o].x - i) * e + (r = u[o].y - n) * r : Math.abs(u[o] - i)) < a &&
                    ((a = e), (s = o))
    ...
    return (
      ba(t, function (t) {
        for (var e in ((zt[t] = ot[t] = a), (zt[(n = t.toLowerCase())] = r), a))
          zt[n + ('easeIn' === e ? '.in' : 'easeOut' === e ? '.out' : '.inOut')] = zt[t + '.' + e] =
            a[e]
      }),
      a
    )
  ...
  var It,
    ...
    Nt =
      ...
      (It.totalDuration = function totalDuration(t) {
        return arguments.length
          ? ((this._dirty = 0),
            Ka(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
          : this._tDur
      }),
      ...
      (It.time = function time(t, e) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), t + xa(this)) % (this._dur + this._rDelay) ||
                (t ? this._dur : 0),
              e,
            )
          : this._time
      ...
      (It.progress = function progress(t, e) {
        return arguments.length
          ? this.totalTime(
              this.duration() * (!this._yoyo || 1 & this.iteration() ? t : 1 - t) + xa(this),
              e,
            )
          : this.duration()
      ...
      (It.endTime = function endTime(e) {
        return (
          this._start + (t(e) ? this.totalDuration() : this.duration()) / Math.abs(this._ts || 1)
        )
      }),
      ...
      (e.render = function render(t, e, r) {
        ...
        if ((this !== I && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
          ...
          if (
            h &&
            !e &&
            (this.pause(), (h.render(c <= i ? 0 : -V)._zTime = c <= i ? 1 : -1), this._ts)
          )
        ...
        return arguments.length
          ? ((this._forcing = 1),
            !this._dp &&
              this._ts &&
              (this._start = da(
                Dt.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts),
              )),
      ...
      if (
        ...
        for (e._pt = e._ptCache = 0, b = (A && t(b)) || (b && !A), n = 0; n < S.length; n++) {
          ...
          e._op && e._op[n] && e.kill(o, e._op[n]),
            E &&
              e._pt &&
              ((Yt = e), I.killTweensOf(o, d, e.globalTime(r)), (m = !e.parent), (Yt = 0)),
            e._pt && b && (lt[h.id] = 1)
        }
          ...
          if (J(w))
            ...
            for (f in h)
              for (
                ...
                ((S = { ease: (D = A[u]).e, duration: ((D.t - (u ? A[u - 1].t : 0)) / 100) * m })[
                  f
                ] = D.v),
                  o.to(C, S, z),
                  (z += S.duration)
        ...
        if (p) {
          if (
            ...
            ;(l && l.render(t < 0 ? t : !i && u ? -V : l._dur * l._ease(i / this._dur), e, r)) ||
              ...
              this._onUpdate &&
                !e &&
                (t < 0 && this._startAt && this._startAt.render(t, !0, r), Ot(this, 'onUpdate')),
              this._repeat &&
                a !== o &&
                this.vars.onRepeat &&
                !e &&
              ...
              (c !== this._tDur && c) ||
                ...
                (!t && p) ||
                  !((c === this._tDur && 0 < this._ts) || (!c && this._ts < 0)) ||
                  ta(this, 1),
                e ||
                  (t < 0 && !d) ||
                  (!c && !d) ||
            ...
            if (
              ...
              t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                ...
                (e >= t._tDur || e < 0) &&
                  t.ratio === u &&
                  (u && ta(t, 1),
                  r || (Ot(t, u ? 'onComplete' : 'onReverseComplete', !0), t._prom && t._prom()))
      ...
      (e.kill = function kill(t, e) {
        ...
        for (
          ...
          if (~d.indexOf(f[l]))
            ...
            s))
              (h = n && n[u]) &&
                (('kill' in h.d && !0 !== h.d.kill(u)) || sa(this, h, '_pt'), delete n[u]),
                'all' !== a && (a[u] = 1)
  ...
  var ue = {
    ...
    exportRoot: function exportRoot(e, r) {
      ...
      for (
        ...
        (n = i._next),
          (!r && !i._dur && i instanceof $t && i.vars.onComplete === i._targets[0]) ||
      ...
      selector: function selector(r) {
        return (
          ...
          function (t) {
            ...
            return xt(
              t,
              e.querySelectorAll ? e : e === r ? O('Invalid scope') || a.createElement('div') : r,
            )
          }
        )
      },
    ...
    ue.registerPlugin(
      {
        ...
        init: function init(t, e, r, i, n) {
          var a, s
          for (a in e)
            (s = this.add(t, 'setAttribute', (t.getAttribute(a) || 0) + '', e[a], i, n, 0, 0, a)) &&
              (s.op = a),
              this._props.push(a)
        },
      },
  ...
  var le,
    ...
    He = function _parseTransform(t, e) {
      ...
      return (
        ...
        (r.x =
          ...
          ((r.xPercent =
            i &&
            ((!e && r.xPercent) || (Math.round(t.offsetWidth / 2) === Math.round(-i) ? -50 : 0)))
        ...
        (r.y =
          ...
          ((r.yPercent =
            n &&
            ((!e && r.yPercent) || (Math.round(t.offsetHeight / 2) === Math.round(-n) ? -50 : 0)))
    ...
    ar = function _renderSVGTransforms(t, e) {
      ...
      ;(d = parseFloat(d)),
        ...
        (v || y || T || b) &&
          ((x = ca(x + v - (v * r + y * n) + T)), (k = ca(k + y - (v * i + y * a) + b))),
        (u || h) &&
          ((s = g.getBBox()),
          ...
          if ('autoRound' !== d && ((s = e[d]), !ft[d] || !Ub(d, e, r, i, t, n)))
            if (
              ...
              if (
                ...
                if (
                  (g ||
                    ...
                    ((g = this._pt =
                      new oe(this._pt, w, Ve, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)),
                  'scale' === d)
                )
                  (this._pt = new oe(
                    this._pt,
                  ...
                  if ('transformOrigin' === d) {
                    ;(s = Id(s)),
                      v.svg
                        ? Qd(t, s, 0, y, 0, this)
                        : ((p = parseFloat(s.split(' ')[2]) || 0) !== v.zOrigin &&
                            Cd(this, v, 'zOrigin', v.zOrigin, p),
              ...
              if (m || ((u || 0 === u) && (h || 0 === h) && !Ye.test(s) && d in w))
                (u = u || 0),
                  (_ = (a + '').substr((h + '').length)) !==
                    (p = Ra(s) || (d in U.units ? U.units[d] : _)) && (h = Ed(t, d, a, p)),
                  (this._pt = new oe(
                    this._pt,
                    m ? v : w,
                    d,
