...
!(function (e, t) {
  ...
  function O(e) {
    return (
      (we = e || q()) &&
        ...
        (Ee = k.isTouch =
          Me.matchMedia && Me.matchMedia('(hover: none), (pointer: coarse)').matches
            ? 1
            : 'ontouchstart' in Me || 0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints
              ? 2
              : 0),
        (ze = k.eventTypes =
          (
    ...
    ((Observer.prototype.init = function init(e) {
      ...
      function Se() {
        ...
        T && (r || n) && T(se, e, t, be, me),
          ...
          n &&
            ...
            (ce = se.deltaY),
            (me[0] = me[1] = me[2] = 0)),
          (ne || re) && (Y && Y(se), $ && oe && $(se), re && (h(se), (re = !1)), (ne = oe = !1)),
          ie && (U(se), (ie = !1)),
          (ee = 0)
      }
        ...
        if (!Qe(e, 1)) {
          ...
          ;(se.x = t),
            ...
            (o || Math.abs(se.startX - t) >= a || Math.abs(se.startY - r) >= a) &&
              (h && (re = !0), o || (se.isDragging = !0), Ue(n, i), o || (p && p(se)))
        }
      }
      ...
      function Xe(t) {
        if (!Qe(t, 1)) {
          B(F ? n : ve, ze[1], Ve, !0)
          var e =
              se.isDragging && (3 < Math.abs(se.x - se.startX) || 3 < Math.abs(se.y - se.startY)),
            r = L(t)
          e ||
            (se._vx.reset(),
            se._vy.reset(),
      ...
      ;(te = se._dc =
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed && (se._vx.reset(), se._vy.reset(), B(F ? n : ve, ze[1], Ve, !0)),
  ...
  function Fa(e, t) {
    ...
    return (r = 'scroll' + n) && (o = y(e, r))
      ? o() - Ca(e)()[i]
      : Ba(e)
        ? (qe[r] || Ge[r]) - (je['inner' + n] || qe['client' + n] || Ge['client' + n])
        : e[r] - e['offset' + n]
  }
  ...
  function tb(e, t) {
    if (Ha(e)) {
      ...
      ~r && (e.indexOf('%') > r && (n *= t / 100), (e = e.substr(0, r - 1))),
        (e =
          n +
          (e in Y ? Y[e] * t : ~e.indexOf('%') ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0))
    }
    return e
  }
  ...
  function Ab() {
    ;(h && h.isPressed && !(h.startX > Ge.clientWidth)) ||
      (T.cache++, (x = x || requestAnimationFrame(ee)), pt || V('scrollStart'), (pt = dt()))
  }
  ...
  function Cb() {
    T.cache++,
      rt ||
        ...
        (v && m === je.innerWidth && !(Math.abs(je.innerHeight - b) > 0.25 * je.innerHeight)) ||
        l.restart(!0)
  }
    ...
    if (w !== r || ft) {
      for (Q(); i < U.length; i += 4)
        (t = je.matchMedia(U[i]).matches) !== U[i + 3] &&
          ((U[i + 3] = t) ? n.push(i) : Q(1, U[i]) || (Ia(U[i + 2]) && U[i + 2]()))
    ...
    if (o) {
      ...
      ;(p = 'scroll' + n.d2),
        X(
          ...
          S,
          n,
          (_ && 20 < S) || (!_ && (u ? Math.max(Ge[p], qe[p]) : o.parentNode[p]) <= S + 1),
        ),
        u && ((l = Mt(a)), u && (o.style[n.op.p] = l[n.op.p] - n.op.m - o._offset + kt))
    }
    return (
      d &&
        h &&
    ...
    function Qj(e, t, r, n, i) {
      ...
      return (
        ...
        ((t.modifiers = s)[d] = function (e) {
          return (
            (e = ya(f())) !== c && e !== u && 2 < Math.abs(e - c) && 2 < Math.abs(e - u)
              ? (o.kill(), (Qj.tween = 0))
  ...
  var We,
    ...
    ee = function _updateAll() {
      if (!ct) {
        ...
        if (
          ((Et = n < $ ? -1 : 1),
          ($ = n),
          r && (pt && !nt && 200 < t - pt && ((pt = 0), V('scrollEnd')), (tt = S), (S = t)),
          Et < 0)
        ) {
    ...
    oe =
      ((ScrollTrigger.prototype.init = function init(_, T) {
        if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), gt)) {
          var k,
            ...
            K,
            o,
            Z = (_ = fb(Ha(_) || Ja(_) || _.nodeType ? { trigger: _ } : _, Ct)).onUpdate,
            $ = _.toggleClass,
            a = _.id,
            ee = _.onToggle,
            te = _.onRefresh,
          ...
          if (
            ...
            (Se.vars = _),
            (T = T || _.animation),
            'refreshPriority' in _ && ((ot = 1), -9999 === _.refreshPriority && (ut = Se)),
            (c.tweenScroll = c.tweenScroll || { top: gc(ve, Ne), left: gc(ve, Re) }),
            ...
            T &&
              ((T.vars.lazy = !1),
              T._initted ||
                (!1 !== T.vars.immediateRender && !1 !== _.immediateRender && T.render(0, !0, !0)),
                  ...
                  if (e <= O && C <= e && c !== e) {
                    ...
                    !1 === ce.inertia && (a = l - n),
                      k(
                        c,
                        {
                          duration: g(ht((0.185 * Math.max(ht(s - i), ht(l - i))) / o / 0.05 || 0)),
                          ease: ce.ease || 'power3',
                          data: ht(c - e),
          ...
          ;(Se.previous = function () {
                ...
                if (ie && e && pt) nb(ScrollTrigger, 'scrollEnd', Jb)
                  ...
                  for (
                    var r,
                      ...
                      b = _.end,
                      m = _.endTrigger || ne,
                      y = _.start || (0 !== _.start && ne ? (ie ? '0 0' : '0 100%') : 0),
                      x = (Se.pinnedContainer = _.pinnedContainer && I(_.pinnedContainer)),
                  ...
                  for (
                    Ia(y) && (y = y(Se)),
                      C = dc(y, ne, d, ge, Ce(), P, B, Se, p, we, me, g, fe) || (ie ? -0.001 : 0),
                      Ia(b) && (b = b(Se)),
                      Ha(b) &&
                        !b.indexOf('+=') &&
                        (~b.indexOf(' ')
                          ? (b = (Ha(y) ? y.split(' ')[0] : '') + b)
                          : ((h = tb(b.substr(2), d)), (b = Ha(y) ? y : C + h), (m = ne))),
                      O =
                        Math.max(
                          C,
                          dc(
                  ...
                  f &&
                    ...
                    Se.revert(!1),
                    j && ((Me = -1), Se.isActive && Ce(C + z * Q), j.restart(!0)),
                    (rt = 0),
                    T &&
                      he &&
                      (T._initted || G) &&
                    ...
                    (Q === Se.progress && !fe) ||
                      (T && !he && T.totalProgress(Q, !0), (Se.progress = Q), Se.update(0, 0, 1)),
            ...
            (Se.labelToScroll = function (e) {
              return (
                (T && T.labels && (C || Se.refresh() || C) + (T.labels[e] / T.duration()) * z) || 0
              )
            }),
            ...
            (Se.update = function (e, t, r) {
              if (!fe || r || e) {
                ...
                if (
                  ...
                  if (
                    ((a = (s = (n = Se.isActive = !!d && d < 1) != (!!p && p < 1)) || !!d != !!p),
                    ...
                    he ||
                      (!W || rt || ft
                        ...
                        : ((fe || (ut && ut !== Se)) && W.render(W._dp._time - W._start),
                          W.resetTo
                    ...
                    a && !rt
                      ? (he &&
                        ...
                        de &&
                          ...
                          (Na(Se.callbackAnimation), W ? W.progress(1) : Na(T, !d, 1)))
                      : he && Z && !rt && Z(Se)
                }
                if (w) {
            ...
            (Se.kill = function (e, t) {
              ...
              0 <= r && Ot.splice(r, 1),
                ...
                r || (Se.scroll.rec = 0),
                T && ((T.scrollTrigger = null), e && T.render(-1), t || T.kill()),
                P &&
                  [P, E, B, D].forEach(function (e) {
      ...
      (ScrollTrigger.register = function register(e) {
        return (
          a || ((We = e || Aa()), za() && window.document && ScrollTrigger.enable(), (a = gt)), a
        )
      }),
        ...
        function (e, t) {
          if (
            ...
            f &&
              ...
              ((C && s.vars.scrollY >= o) || o - 1 <= r) && We.to({}, { onUpdate: xp, duration: i })
          } else u.restart(!0)
        }),
      (e.onWheel = function () {
